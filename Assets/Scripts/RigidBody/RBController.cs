...
public class RBController : MonoBehaviour
{
    ...
    //    {
    //        customRigidbody.AddForce(new Vector3(0, 10, 0), transform.position + new Vector3(1, 0, 0));
    //    }
    ...
    //    {
    //        customRigidbody.AddForce(new Vector3(0, 10, 0), transform.position + new Vector3(0, 0, 1));
    //    }
